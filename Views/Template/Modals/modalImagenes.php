...
<?php
	...
	//$pasarvardos = new Home();
	//$arrData1Img = $pasarvardos->getbusca1Img();
                        ...
                        <div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									...
									<!--<div id="ensayo" class="item-slick3">ENSAYO</div>-->
									...
									//var_dump($data['nombreimg']);
									//var_dump($data['arrData1Img'][0]['nombreimg']);
									//var_dump($arrData1Img['nombreimg']);
									//foreach($arrData1Img as $item): 
									//dep($arrData);
                                    ...
                                    <?php  
                                        ...
                                        <?php 
											...
											//dep($data);
                                            //dep($key);
                                            //dep($data[0]['idimg']); // respuesta 1
                                            //var_dump($variablepasada);

                                            //for($i=0; $i<count($arrData); $i++)
                                            //{
                                              //  $arrData['idimg'] =  $variable->getbusca1Img(3);   
                                            //}
									...
									<div class="item-slick3" data-thumb="http://localhost/doctoreeedevelop/Assets/paginappal/images/1613621289295.jpg">
