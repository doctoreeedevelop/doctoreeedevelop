...
<html lang="en">
  <head>
    <meta name="description" content="desarrollador web portafolio">
    
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="DoctoreeeDevelop">
    <meta name="color" content="#009688">
    <link rel="shortcut icon" href="<?= media(); ?>/imagesfavicon.ico"> 
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= BASE_URL(); ?>">DoctoreeeDeveloppppp</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="<?= BASE_URL(); ?>/dashboard/perfil"><i class="fa fa-user fa-lg"></i> Profile</a></li>
